...
/*  	$password = md5($_POST['password']); */
 	...
 	}elseif(!isset($_SESSION['dangnhap_home'])){ 
		$sql_select_khachhang = mysqli_query($con,"SELECT * FROM tbl_khachhang ORDER BY khachhang_id DESC LIMIT 1");
		$mahang = rand(0,9999);
		$row_khachhang = mysqli_fetch_array($sql_select_khachhang);
		for($i=0;$i<count($_POST['thanhtoan_product_id']);$i++){
						...
						?>
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="uploads/<?php echo $row_fetch_giohang['hinhanh'] ?>" alt=" " width="120" height="120" class="img-responsive">
									</a>
								</td>
								<td class="invert">
							...
							<tr>
							<td>(Vui lòng kiểm tra lại thông tin trước khi xác nhận thanh toán)</td>
							</tr>
							<tr>
