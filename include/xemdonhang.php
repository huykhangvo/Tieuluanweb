					...
					<div class="wrapper">
						<!-- first section -->
							...
							<div class="col-md-12">
                               ...
                               /*  GROUP BY tbl_giaodich.magiaodich */
								$sql_select = mysqli_query($con,"SELECT * FROM tbl_giaodich,tbl_donhang WHERE tbl_giaodich.khachhang_id='$id_khachhang'"); 
							 ...
							 if($row_donhang['tinhtrang']==0){
                                echo '<span style="color:#FF0000;text-align:center;">Đã đặt hàng</span>';
                            }else{
                                echo '<span style="color:#AFA;text-align:center;">Đã xử lý|Đang giao hàng</span>';
                            }
										?></td>
										<td>
                        ...
                        ?>
							...
							<div class="col-md-12">
								...
								$sql_select = mysqli_query($con,"SELECT DISTINCT  * FROM tbl_giaodich,tbl_khachhang,tbl_sanpham WHERE tbl_giaodich.sanpham_id=tbl_sanpham.sanpham_id AND tbl_khachhang.khachhang_id=tbl_giaodich.khachhang_id AND tbl_giaodich.magiaodich='$magiaodich' ORDER BY tbl_giaodich.giaodich_id DESC"); 
								?> 
								<table class="table table-bordered ">
									<tr>
										<th>Thứ tự</th>
